...
func lamborghiniStory() {
    var lamborghini = SportCar(model: "Lamborghini Huracan", year: 2014, maxPassengers: 2, color: "red")
    lamborghini.show()
...
func dodgeTruckStory() {
    var dodgeTruck  = TrunkCar(model: "Dodge Power Wagon", year: 1950, volume: 4_000.0)
    dodgeTruck.show()
...
func coolCarStory() {
    var coolCar = SportCar(model: "Swift Car", year: 2016, maxPassengers: 8_000_000_000, color: "orange")
    coolCar.show()
